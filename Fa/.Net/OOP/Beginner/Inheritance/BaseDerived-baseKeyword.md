...
1. [مقدمه: چرا Base و Derived مهم هستند؟](#مقدمه-چرا-base-و-derived-مهم-هستند)  
2. [مفهوم وراثت (Inheritance) در C#](#مفهوم-وراثت-inheritance-در-c)  
3. [کلاس پایه (Base Class) و کلاس مشتق شده (Derived Class)](#کلاس-پایه-base-class-و-کلاس-مشتق-شده-derived-class)  
4. [نحوه تعریف کلاس مشتق شده](#نحوه-تعریف-کلاس-مشتق-شده)  
5. [دسترسی به اعضای کلاس پایه در کلاس مشتق شده](#دسترسی-به-اعضای-کلاس-پایه-در-کلاس-مشتق-شده)  
6. [کلیدواژه `base` — چیست و چه کاربردی دارد؟](#کلیدواژه-base--چیست-و-چه-کاربردی-دارد)  
7. [استفاده از `base` برای فراخوانی سازنده کلاس پایه](#استفاده-از-base-برای-فراخوانی-سازنده-کلاس-پایه)  
8. [استفاده از `base` برای فراخوانی متدها و ویژگی‌های کلاس پایه](#استفاده-از-base-برای-فراخوانی-متدها-و-ویژگیهای-کلاس-پایه)  
9. [Override کردن متدها و استفاده از `base` در آن](#override-کردن-متدها-و-استفاده-از-base-در-آن)  
10. [محدودیت‌ها و نکات مهم](#محدودیتها-و-نکات-مهم)  
11. [مثال‌های کاربردی](#مثالهای-کاربردی)  
12. [جمع‌بندی](#جمعبندی)  
13. [منابع معتبر](#منابع-معتبر)
...
- `base()` فقط در سازنده‌ها و فقط در خط اول مجاز است.
