...
8. [استفاده از `base` برای فراخوانی متدها و ویژگی‌های کلاس پایه](#8-استفاده-از-base-برای-فراخوانی-متدها-و-ویژگیهای-کلاس-پایه)  
9. [Override کردن متدها و استفاده از `base` در آن](#override-کردن-متدها-و-استفاده-از-base-در-آن)  
10. [محدودیت‌ها و نکات مهم](#10-محدودیتها-و-نکات-مهم)  
11. [مثال‌های کاربردی](#11-مثالهای-کاربردی)  
12. [جمع‌بندی](#12-جمعبندی)  
