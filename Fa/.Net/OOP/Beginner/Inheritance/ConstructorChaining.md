...
1. [مقدمه: چرا Constructor Chaining مهم است؟](#مقدمه-چرا-constructor-chaining-مهم-است)  
2. [مفهوم Constructor Chaining چیست؟](#مفهوم-constructor-chaining-چیست)  
3. [انواع Constructor Chaining در C#](#انواع-constructor-chaining-در-c)  
4. [Chaining با استفاده از `this` — داخل یک کلاس](#chaining-با-استفاده-از-this--داخل-یک-کلاس)  
5. [Chaining با استفاده از `base` — به کلاس پایه](#chaining-با-استفاده-از-base--به-کلاس-پایه)  
6. [چرا Constructor Chaining مفید است؟](#چرا-constructor-chaining-مفید-است)  
7. [قوانین و محدودیت‌های Constructor Chaining](#قوانین-و-محدودیتهای-constructor-chaining)  
8. [مثال‌های کاربردی و واقعی](#مثالهای-کاربردی-و-واقعی)  
9. [مقایسه با رویکردهای قدیمی (تکرار کد)](#مقایسه-با-رویکردهای-قدیمی-تکرار-کد)  
10. [نکات بهینه‌سازی و بهترین روش‌ها (Best Practices)](#نکات-بهینهسازی-و-بهترین-روشها-best-practices)  
11. [جمع‌بندی](#جمعبندی)  
...
✅ **همیشه سازنده کلاس پایه را در کلاس‌های مشتق شده فراخوانی کنید** — حتی اگر به صورت ضمنی انجام شود.
