...
1. [مقدمه: ارث‌بری چیست؟](#1-مقدمه-ارثبری-چیست)
2. [انواع ارث‌بری در C#](#2-انواع-ارثبری-در-c)
3. [ارث‌بری چندسطحی (Multi-level Inheritance)](#3-ارثبری-چندسطحی-multi-level-inheritance)
4. [ارث‌بری سلسله‌مراتبی (Hierarchical Inheritance)](#4-ارثبری-سلسلهمراتبی-hierarchical-inheritance)
5. [تفاوت Multi-level و Hierarchical Inheritance](#5-تفاوت-multi-level-و-hierarchical-inheritance)
6. [نکات مهم و بهترین روش‌ها (Best Practices)](#6-نکات-مهم-و-بهترین-روشها-best-practices)
