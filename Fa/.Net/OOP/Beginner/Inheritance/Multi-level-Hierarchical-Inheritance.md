...
1. [مقدمه: ارث‌بری چیست؟](#مقدمه-ارثبری-چیست)
2. [انواع ارث‌بری در C#](#انواع-ارثبری-در-c)
3. [ارث‌بری چندسطحی (Multi-level Inheritance)](#ارثبری-چندسطحی-multi-level-inheritance)
   - تعریف
   - نحوه پیاده‌سازی
   - مثال عملی
   - کاربردها و مزایا
4. [ارث‌بری سلسله‌مراتبی (Hierarchical Inheritance)](#ارثبری-سلسلهمراتبی-hierarchical-inheritance)
   - تعریف
   - نحوه پیاده‌سازی
   - مثال عملی
   - کاربردها و مزایا
5. [تفاوت Multi-level و Hierarchical Inheritance](#تفاوت-multi-level-و-hierarchical-inheritance)
6. [نکات مهم و بهترین روش‌ها (Best Practices)](#نکات-مهم-و-بهترین-روشها-best-practices)
7. [خطاهای رایج و نحوه جلوگیری از آنها](#خطاهای-رایج-و-نحوه-جلوگیری-از-آنها)
8. [جمع‌بندی](#جمعبندی)
...
> ⚠️ هشدار: اگر سلسله ارث‌بری خیلی طولانی شود، کد پیچیده و سخت‌نگهدار می‌شود (مشکل "مثلث مرگ" در OOP).
