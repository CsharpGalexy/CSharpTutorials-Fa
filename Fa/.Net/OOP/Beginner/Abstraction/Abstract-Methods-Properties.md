...
1. [مقدمه: OOP و اهمیت انتزاع](#مقدمه1--oop-و-اهمیت-انتزاع)  
2. [کلمه کلیدی `abstract` چیست؟](#کلمه-کلیدی-abstract-چیست)  
3. [کلاس‌های انتزاعی (Abstract Classes)](#کلاس‌های-انتزاعی-abstract-classes)  
4. [متدهای انتزاعی (Abstract Methods)](#متدهای-انتزاعی-abstract-methods)  
5. [خواص انتزاعی (Abstract Properties)](#خواص-انتزاعی-abstract-properties)  
6. [تفاوت با متدها و خواص مجازی (Virtual)](#تفاوت-با-متدها-و-خواص-مجازی-virtual)  
7. [مثال‌های عملی و کاربردی](#مثال‌های-عملی-و-کاربردی)  
8. [قوانین و محدودیت‌های مهم](#قوانین-و-محدودیت‌های-مهم)  
9. [کاربردهای واقعی در طراحی نرم‌افزار](#کاربردهای-واقعی-در-طراحی-نرمافزار)  
10. [جمع‌بندی و نکات کلیدی](#جمعبندی-و-نکات-کلیدی)  
