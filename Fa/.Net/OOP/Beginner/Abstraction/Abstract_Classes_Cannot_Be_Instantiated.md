...
3. [چرا کامپایلر C# اجازه نمونه‌سازی از کلاس انتزاعی را نمی‌دهد؟](#3-چرا-کامپایلر-c-اجازه-نمونهسازی-از-کلاس-انتزاعی-را-نمیدهد)
4. [چه زمانی این خطا رخ می‌دهد؟ (با مثال کد)](#4-چه-زمانی-این-خطا-رخ-میدهد-با-مثال-کد)
5. [تفاوت با Interface و کلاس معمولی](#5-تفاوت-با-interface-و-کلاس-معمولی)
6. [راه‌های دور زدن این محدودیت — و چرا نباید!](#6-راههای-دور-زدن-این-محدودیت--و-چرا-نباید)
...
9. [جمع‌بندی — نکات طلایی برای مبتدیان](#9-جمعبندی--نکات-طلایی-برای-مبتدیان)
