...
# 📘 سه نوع سازنده مهم: Default, Parameterized, Overloading  
...
1. 🔹 **۱. سازنده پیش‌فرض (Default Constructor)**
   - 🟢 **سطح مقدماتی**
   - 🟡 **سطح متوسط**
   - 🔴 **سطح حرفه‌ای**

2. 🔹 **۲. سازنده پارامتردار (Parameterized Constructor)**
   - 🟢 **سطح مقدماتی**
   - 🟡 **سطح متوسط**
   - 🔴 **سطح حرفه‌ای**

3. 🔹 **۳. بازتعریف سازنده (Constructor Overloading)**
   - 🟢 **سطح مقدماتی**
   - 🟡 **سطح متوسط**
   - 🔴 **سطح حرفه‌ای**
