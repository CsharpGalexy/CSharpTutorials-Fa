...
صحبت می‌کنم، و این رو از **مقدماتی تا حرفه‌ای** پیش می‌برم. همه چیز دربارهٔ همین سه مورد، بدون پراکندگی.
...
اگر بخوای، یک **چک‌لیست عملی** از بهترین روش‌ها برای استفاده از این سه نوع سازنده می‌تونم بدم. 😊

### USER
بده

### ASSISTANT
عالی! در ادامه یک **چک‌لیست عملی و حرفه‌ای** برای استفاده از  
🔹 **Default Constructor**  
🔹 **Parameterized Constructor**  
🔹 **Constructor Overloading**  
