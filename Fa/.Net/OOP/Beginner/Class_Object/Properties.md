...
1. [🛠️ خصوصیات خود-پیاده‌سازی‌شده (Auto-Implemented)](#%EF%B8%8F-خصوصیات-خود-پیادهسازیشده-auto-implemented-properties)
...
6. [➗ خصوصیات بدنه‌عبارت (Expression-bodied)](#-خصوصیات-بدنهعبارت-expression-bodied-properties)
7. [📊 خصوصیات محاسبه‌شده (Computed)](#-خصوصیات-محاسبهشده-computed-properties)
8. [🧱 فیلدهای پشتیبان (Backing Fields)](#-فیلدهای-پشتیبان-backing-fields)
9. [📌 تفاوت‌ها و ارتباط‌های کلیدی](#-تفاوتها-و-ارتباطهای-کلیدی)
10. [🎯 جمع‌بندی نهایی](#-جمعبندی-نهایی)
